<div class="wrap">
    <h2>Forum - <?php _e('User Groups', 'mingle-forum'); ?></h2>
    <?php if ($saved): ?>
        <div class="updated">
                ...
                <?php if (!empty($user_groups)): ?>
                    <?php foreach ($user_groups as $group): ?>
                        <li class="ui-state-default mf_user_group_li_item">
                            ...
                            <label><?php _e('Name:', 'mingle-forum'); ?>&nbsp;<input type="text" name="user_group_name[]" value="<?php echo esc_html(stripslashes($group->name)); ?>" /></label>&nbsp;&nbsp;
                            <label><?php _e('Description:', 'mingle-forum'); ?>&nbsp;<input type="text" name="user_group_description[]" value="<?php echo esc_html(stripslashes($group->description)); ?>" size="40" /></label>&nbsp;&nbsp;
