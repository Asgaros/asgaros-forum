<div class="wrap" id="af-options">
    ...
    <form method="post">
        <p>
            <label for="posts_per_page"><?php _e('Replies to show per page:', 'asgarosforum'); ?></label>
            <input type="text" name="posts_per_page" id="posts_per_page" value="<?php echo stripslashes($asgarosforum->options['posts_per_page']); ?>" />
        </p>
        <p>
            <label for="threads_per_page"><?php _e('Threads to show per page:', 'asgarosforum'); ?></label>
        ...
        <p>
            ...
            <label for="allow_file_uploads"><?php _e('Allow file uploads', 'asgarosforum'); ?></label>
        </p>
        <input type="submit" name="af_options_submit" class="button button-primary" value="<?php _e('Save Options', 'asgarosforum'); ?>" />
    </form>
</div>
