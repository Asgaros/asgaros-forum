        ...
        <?php if (!empty($categories)): ?>
            <?php foreach ($categories as $cat): ?>
                ...
                <fieldset class="af_fset">
                    ...
                    <ol class="sortable_elements af_ordered_list" id="sortable-forums-<?php echo $cat->id; ?>">
                        <?php if (!empty($forums)): ?>
                            <?php foreach ($forums as $forum): ?>
                                <li class="ui-state-default">
                                    <input type="hidden" name="af_forum_id[<?php echo $cat->id; ?>][]" value="<?php echo $forum->id; ?>" />
                        ...
                        <?php else: ?>
                            <li class="ui-state-default">
                                <input type="hidden" name="af_forum_id[<?php echo $cat->id; ?>][]" value="new" />
                    ...
                    <a href="#" class="af_add_new_forum dashicons-before dashicons-plus" title="<?php _e('Add new Forum', 'asgarosforum'); ?>" data-value="<?php echo $cat->id; ?>"><?php _e('Add new Forum', 'asgarosforum'); ?></a>
                </fieldset>
            <?php endforeach; ?>
