...
<div class="thread">
    ...
    <div class="thread-name">
        <strong><a href="<?php echo $this->get_link($thread->id, $this->links->topic); ?>" title="<?php echo esc_html(stripslashes($thread->name)); ?>"><?php echo esc_html($this->cut_string(stripslashes($thread->name))); ?></a></strong>
