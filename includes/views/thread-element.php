...
<div class="thread">
    ...
    <div class="thread-name">
        <strong><a href="<?php echo $this->rewrite->getLink('topic', $thread->id); ?>" title="<?php echo esc_html(stripslashes($thread->name)); ?>"><?php echo esc_html($this->cut_string(stripslashes($thread->name))); ?></a></strong>
