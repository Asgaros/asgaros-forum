    ...
    public function widget($args, $instance) {
		...
		if (!empty($posts)) {
            ...
            foreach ($posts as $post) {
                echo '<li>';
                echo '<span class="post-link"><a href="'.$asgarosforum->get_widget_link($post->parent_id, $post->id, get_the_permalink($target)).'">'.esc_html($asgarosforum->cut_string(stripslashes($post->name))).'</a></span>';
